...
#*************************************************************************************************************** 
rango_mayor=25000 #el precio maximo para los naranjos
rango_menor=15000  # el precio minimo para los naranjos
...
def db():
    ...
    datos_naranjos=[    # primero creamos una lista para 
         (0,2000,2001,True,0,20,20,00.2),
         (1,2000,2001,True,0,20,20,00.2),
         (2,2000,2001,True,0,20,20,00.2)] 
    ...
    bd_cursor.executemany("INSERT INTO NARANJOS VALUES(?,?,?,?,?,?,?,?)",datos_naranjos)
...
def cada_tick():
   ...
   for x in range(100):         
        ...
        #-------------vamos a ir sumando el balance de cada naranjo 
